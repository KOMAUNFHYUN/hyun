...
public class BoardDAO extends EgovAbstractDAO {
	 ...
	 * @exception Exception
	 */
	public List<?> selectBoardList(BoardDefaultVO BoardVO) throws Exception {
	 ...
	 * @exception
	 */
	public int selectBoardListTotCnt(BoardDefaultVO BoardVO) {
		return (Integer) select("sampleDAO.selectBoardListTotCnt", BoardVO);
	}
